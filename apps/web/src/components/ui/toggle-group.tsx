...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive
      ...
      className={cn(
        "data-[spacing=0]:data-[variant=outline]:rounded-4xl group/toggle-group flex w-fit items-center gap-[--spacing(var(--gap))] data-[orientation=horizontal]:flex-row data-[orientation=vertical]:flex-col data-[orientation=vertical]:items-stretch",
        className
      )}
      {...props}
    >
